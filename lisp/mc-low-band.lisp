...
(defun EXPLORE-LOOKAHEAD (&optional (n 10))
	(run-scatter :cases '(sink-low-band bal-low-band) 
							 ...
							 :trials n 
							 :filename "lookahead-low-band.out")
	)
...
(defun EXPLORE-HAZARD-TRIGGER (&optional (n 10))
	(run-scatter :cases '(sink-low-band bal-low-band) 
							 ...
							 :trials n 
							 :filename "hazard-trigger-low-band.out")
	)
...
(defun EXPLORE-BUMPER-TRIGGER (&optional (n 10))
	(run-scatter :cases '(sink-low-band bal-low-band) 
							 ...
							 :trials n 
							 :filename "bumper-trigger-low-band.out")
	)
...
(defun EXPLORE-HAZARD-EVAL (&optional (n 10))
	(run-scatter :cases '(sink-low-band bal-low-band) 
							 ...
							 :trials n 
							 :filename "hazard-response-low-band.out")
	)
...
(defun EXPLORE-BUMPER-EVAL (&optional (n 10))
	(run-scatter :cases '(sink-low-band bal-low-band) 
							 ...
							 :trials n 
							 :filename "bumper-response-low-band.out")
	)
...
(defun EXPLORE-DECSION-TIME-DAY (&optional (n 10))
	(run-scatter :cases '(sink-low-band bal-low-band) 
							 ...
							 :trials n 
							 :filename "decision-time-day-low-band.out")
	)
...
(defun EXPLORE-DECSION-TIME-NIGHT (&optional (n 10))
	(run-scatter :cases '(sink-low-band bal-low-band) 
							 ...
							 :trials n 
							 :filename "decision-time-night-low-band.out")
	)
