...
(defun EXPLORE-LOOKAHEAD (&optional (n 10))
	(run-scatter :cases '(bal-high-lat sink-high-lat bumper-car) 
							 ...
							 :trials n 
							 :filename "lookahead-high-lat.out")
	)
...
(defun EXPLORE-HAZARD-TRIGGER (&optional (n 10))
	(run-scatter :cases '(bal-high-lat sink-high-lat bumper-car) 
							 ...
							 :trials n 
							 :filename "hazard-trigger-high-lat.out")
	)
...
(defun EXPLORE-BUMPER-TRIGGER (&optional (n 10))
	(run-scatter :cases '(bal-high-lat sink-high-lat bumper-car) 
							 ...
							 :trials n 
							 :filename "bumper-trigger-high-lat.out")
	)
...
(defun EXPLORE-HAZARD-EVAL (&optional (n 10))
	(run-scatter :cases '(bal-high-lat sink-high-lat bumper-car) 
							 ...
							 :trials n 
							 :filename "hazard-response-high-lat.out")
	)
...
(defun EXPLORE-BUMPER-EVAL (&optional (n 10))
	(run-scatter :cases '(bal-high-lat sink-high-lat bumper-car) 
							 ...
							 :trials n 
							 :filename "bumper-response-high-lat.out")
	)
...
(defun EXPLORE-DECSION-TIME-DAY (&optional (n 10))
	(run-scatter :cases '(bal-high-lat sink-high-lat bumper-car) 
							 ...
							 :trials n 
							 :filename "decision-time-day-high-lat.out")
	)
...
(defun EXPLORE-DECSION-TIME-NIGHT (&optional (n 10))
	(run-scatter :cases '(bal-high-lat sink-high-lat bumper-car) 
							 ...
							 :trials n 
							 :filename "decision-time-night-high-lat.out")
	)
